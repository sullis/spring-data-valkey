= Spring Data Redis image:https://jenkins.spring.io/buildStatus/icon?job=spring-data-valkey%2Fmain&subject=Build[link=https://jenkins.spring.io/view/SpringData/job/spring-data-valkey/] https://gitter.im/spring-projects/spring-data[image:https://badges.gitter.im/spring-projects/spring-data.svg[Gitter]] image:https://img.shields.io/badge/Revved%20up%20by-Develocity-06A0CE?logo=Gradle&labelColor=02303A["Revved up by Develocity", link="https://ge.spring.io/scans?search.rootProjectNames=Spring Data Redis"]
...
* Report bugs with Spring Data Redis at https://github.com/spring-projects/spring-data-valkey/issues/new[github.com/spring-projects/spring-data-valkey].
