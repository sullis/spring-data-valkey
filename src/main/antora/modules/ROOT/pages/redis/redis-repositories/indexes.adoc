...
https://redis.io/topics/indexes[Secondary indexes] are used to enable lookup operations based on native Valkey structures.
...
.Index Setup with @EnableValkeyRepositories
====
[source,java]
----
@Configuration
