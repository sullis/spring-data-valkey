...
Fully qualified name of the enclosing class `org.springframework.data.redis.connection.lettuce.observability.ValkeyObservation`.
...
|`db.redis.database_index`|Valkey database index.
...
|`spring.data.redis.command.error`|Valkey error response.
|===
